    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="Reportper.html">
              <i class="bi bi-circle"></i><span>Report Absensi Karyawan</span>
            </a>
          </li>
          <li>
            <a href="Reportrekap.html">
              <i class="bi bi-circle"></i><span>Report Rekap Absensi Karyawan</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title" align="center">Daftar Shift Karyawan</h5>
          ...
          <!-- Recent Sales -->
                    <div class="col-12">
                      <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Tambah Daftar Divisi</h5>
                          ...
                          <table class="table table-borderless datatable">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><span class="badge bg-success">Hapus</span></td>
                              </tr>
                            </tbody>
                          </table>
